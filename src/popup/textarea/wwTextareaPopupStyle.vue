...
export default {
    ...
    methods: {
        ...
        setValue(prop, value) {
            this.options.data.wwObject.data.textarea.style = this.options.data.wwObject.data.textarea.style || {};
            this.props[prop] = value;
            this.options.data.wwObject.data.textarea.style[prop] = value;
            if (prop == 'borderWidth') {
                if (value == 0) {
                    this.props.borderStyle = 'none';
                    this.options.data.wwObject.data.textarea.style.borderStyle = 'none';
                }
                else if (this.props.borderStyle == 'none') {
                    this.props.borderStyle = 'solid';
                    this.options.data.wwObject.data.textarea.style.borderStyle = 'solid';
                }
            }
            if (prop == 'borderStyle') {
                if (value == 'none') {
                    this.props.borderWidth = 0;
                    this.options.data.wwObject.data.textarea.style.borderWidth = 0;
                }
                else if (this.props.borderWidth == 0) {
                    this.props.borderWidth = 2;
                    this.options.data.wwObject.data.textarea.style.borderWidth = 2;
                }
            }
            if (prop == 'borderColor') {
                this.props.borderWidth = this.options.data.wwObject.data.textarea.style.borderWidth || 1;
                this.options.data.wwObject.data.textarea.style.borderWidth = this.props.borderWidth;
            }
            this.updateWwObject();
        }
    },
    ...
    created() {
        ...
        for (let key in this.props) {
            this.props[key] = this.options.data.wwObject.data.textarea.style[key] || this.props[key];
        }
    },
    beforeDestroy() {
    }
